...
class Tutorial (object):
	...
	def act_like_router (self, packet, packet_in):
		...
		if packet.type == pkt.ethernet.ARP_TYPE:
			...
			if etherPayload.opcode == pkt.arp.REQUEST:
				...
				arp_reply = pkt.arp()
				arp_reply.hwsrc = adr.EthAddr("40:40:10:40:40:10")  # fake mac in response
	...
	def createFlow(self, packet_in, packet, out_port):
		...
		#keeping the flow matches low increases the range of matches, few matching rules overlapping
		msg = of.ofp_flow_mod()
